...
const sendRecoveryEmail = (email, code) => {
  ...
  var mailOptions = {
    ...
    to: email,
    subject: `Helping Hands Account Recovery`,
    ...
    <p style="line-height: 1.5; word-break: break-word; font-size: 18px; mso-line-height-alt: 27px; margin: 0;"><span style="font-size: 18px;"><strong>You recently requested to reset your password for your account. Use the button below to reset it.</strong></span></p>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
    ...
    <p style="font-size: 12px; line-height: 1.2; word-break: break-word; text-align: left; font-family: inherit; mso-line-height-alt: 14px; margin: 0;"><span style="color: #95979c; font-size: 12px;">Companify Copyright © 2020</span></p>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
    <!--[if (!mso)&(!IE)]><!-->
